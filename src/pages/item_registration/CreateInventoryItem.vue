...
<template>
  <div class="h-screen text-center">
    <Form :validation-schema="inventoryRegistrationSchema" as="div" @submit="onSubmit">
      ...
      <div class="flex flex-wrap w-screen px-8 lg:px-16 mt-6 mb-6">
        <div class="w-full lg:w-1/2 flex flex-col lg:px-24 mb-4">
          ...
          <Field type="text" name="nombre" placeholder="Nombre del producto" id="nombre"
        ...
        <div class="w-full lg:w-1/2 flex flex-col lg:px-24 mb-4">
          ...
          <Field type="date" name="fecha_vencimiento" id="fecha_vencimiento"
            class="bg-gray-50 border border-gray-300 text-gray-900 rounded-lg focus:ring-primary focus:border-primary block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
            required />
          <ErrorMessage name="fecha_vencimiento" class="text-red-600 text-left" />
        </div>
        ...
        <div class="w-full lg:w-1/2 flex flex-col lg:px-24 mb-4">
          ...
          <Field type="text" name="laboratorio" placeholder="Nombre del laboratorio" id="laboratorio"
            class="bg-gray-50 border border-gray-300 text-gray-900 rounded-lg focus:ring-primary focus:border-primary block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
            required />
        ...
        <div class="w-full lg:w-1/2 flex flex-col lg:px-24 mb-4">
          ...
          <Field type="text" name="ingrediente" placeholder="Ingrediente Principal" id="ingrediente"
            class="bg-gray-50 border border-gray-300 text-gray-900 rounded-lg focus:ring-primary focus:border-primary block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
            required />
        ...
        <div class="w-full lg:w-1/2 flex flex-col lg:px-24 mb-4">
          ...
          <Field type="text" name="formato" placeholder="Formato" id="formato"
            class="bg-gray-50 border border-gray-300 text-gray-900 rounded-lg focus:ring-primary focus:border-primary block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
            required />
        ...
        <div class="w-full lg:w-1/2 flex flex-col lg:px-24 mb-4">
          ...
          <Field type="date" name="fecha_registro" id="fecha_registro"
            class="bg-gray-50 border border-gray-300 text-gray-900 rounded-lg focus:ring-primary focus:border-primary block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
            required />
        ...
        <div class="w-full lg:w-1/2 flex flex-col lg:px-24 mb-4">
          ...
          <Field type="text" name="volumen" placeholder="30g" id="volumen"
            class="bg-gray-50 border border-gray-300 text-gray-900 rounded-lg focus:ring-primary focus:border-primary block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
            required />
        ...
        <div class="w-full lg:w-1/2 flex flex-col lg:px-24 mb-4">
          ...
          <Field type="text" name="caja" placeholder="0" id="caja"
            class="bg-gray-50 border border-gray-300 text-gray-900 rounded-lg focus:ring-primary focus:border-primary block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
            required />
        ...
        <div class="w-full lg:w-1/2 flex flex-col lg:px-24 mb-4">
          ...
          <Field type="text" name="cantidad" placeholder="0" id="cantidad"
            class="bg-gray-50 border border-gray-300 text-gray-900 rounded-lg focus:ring-primary focus:border-primary block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
            required />
