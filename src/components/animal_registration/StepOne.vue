...
<template>
  <div class="grid gap-6 md:gap-x-24 md:gap-y-5 mb-6 md:grid-cols-2">
    <div class="md:flex md:items-center md:space-x-4">
      <Field v-slot="{ field, errorMessage }" keep-value name="nombre">
        <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white md:mb-0 md:w-24"
          for="nombre">Nombre<strong>*</strong></label>
        ...
        <div class="flex flex-col w-full">
          <input id="nombre" autocomplete="off"
            ...
            placeholder="Bruno" type="text" v-bind="field" />
    ...
    <div class="md:col-start-1 md:row-start-2 md:flex md:items-center md:space-x-4">
      <Field v-slot="{ field, errorMessage }" keep-value name="edad">
        <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white md:mb-0 md:w-24"
          for="edad">Edad<strong>*</strong></label>
        <div class="flex flex-col w-full">
          <input id="edad"
            ...
            placeholder="" type="number" v-bind="field" />
          <span class="mt-2 text-sm text-red-600 dark:text-red-500">
            {{ errorMessage }}
          </span>
        </div>
    ...
    <div class="md:col-start-2 md:flex md:items-center md:space-x-4">
      <Field v-slot="{ errorMessage }" keep-value name="especie">
        <label class="block mb-2 text-sm font-medium text-gray-900 md:mb-0 md:w-24"
          for="especie">Especie<strong>*</strong></label>
        <div class="flex flex-col w-full">
          <div id="especie"
    ...
    <div class="md:col-start-2 md:flex md:items-center md:space-x-4">
      <Field v-slot="{ errorMessage }" keep-value name="genero">
        <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white md:mb-0 md:w-24"
          for="genero">Género<strong>*</strong></label>
        <div class="flex flex-col w-full">
          <div id="genero"
            class="text-sm font-semibold flex justify-around gap-2 items-center w-full border border-primary h-10">
            <input id="macho" :class="{
              'bg-primary w-full h-2/3 ml-3':
    ...
    <div class="md:flex md:items-center md:space-x-4">
      <Field v-slot="{ field, errorMessage }" keep-value name="ubicacion">
        <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white md:mb-0 md:w-24"
          for="ubicacion">Ubicación<strong>*</strong></label>
        <div class="flex flex-col w-full">
          <input id="ubicacion" autocomplete="off"
            class="block w-full bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary focus:border-primary p-2.5"
            placeholder="Casa" type="text" v-bind="field" />
          <span class="mt-2 text-sm text-red-600 dark:text-red-500">
            {{ errorMessage }}
          </span>
        </div>
    ...
    <div class="md:flex md:items-center md:space-x-4">
      <Field v-slot="{ field, errorMessage }" keep-value name="codigo">
        <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white md:mb-0 md:w-24"
          for="codigo">Código<strong>*</strong></label>
        <div class="flex flex-col w-full">
          <input id="codigo" autocomplete="off"
            class="block w-full bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary focus:border-primary p-2.5"
            placeholder="F-23" type="text" v-bind="field" />
          <span class="mt-2 text-sm text-red-600 dark:text-red-500">
            {{ errorMessage }}
          </span>
        </div>
    ...
    <div class="md:flex md:items-center md:space-x-4">
      <Field v-slot="{ field, errorMessage }" keep-value name="peso">
        <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white md:mb-0 md:w-24"
          for="peso">Peso<strong>*</strong></label>
        <div class="flex flex-col w-full">
          <input id="peso" autocomplete="off"
            class="block w-full bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary focus:border-primary p-2.5"
            placeholder="50" type="number" v-bind="field" />
          <span class="mt-2 text-sm text-red-600 dark:text-red-500">
            {{ errorMessage }}
          </span>
        </div>
  ...
  <div class="mt-5">
    <Field v-slot="{ field, errorMessage }" keep-value name="historia">
      <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white" for="historiaOrigen">Historia de
        origen<strong>*</strong></label>
      <div class="flex flex-col w-full">
        <textarea id="historia"
          class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary focus:border-primary block w-full p-2.5"
          placeholder="Fue encontrado en ..." v-bind="field" />
        <span class="mt-2 text-sm text-red-600 dark:text-red-500">
          {{ errorMessage }}
        </span>
      </div>
