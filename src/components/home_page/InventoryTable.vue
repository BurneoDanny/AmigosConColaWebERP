            ...
            <table class="w-screen text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                <thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                    <tr>
                        ...
                        <th scope="col" class="px-6 py-3">Ingrediente principal</th>
                        <th scope="col" class="px-6 py-3">Formato</th>
                        <th scope="col" class="px-6 py-3">Volumen</th>
                        <th scope="col" class="px-6 py-3">V/Adm</th>
                ...
                <tbody>
                    <tr
                        ...
                        <td class="px-6 py-4">THC 6% / CBD 3%</td>
                        <td class="px-6 py-4">Suspension</td>
                        <td class="px-6 py-4">10ml</td>
                        <td class="px-6 py-4">
                            Oral
                        </td>
                        <td class="px-6 py-4">dd/mm/aa</td>
                        <td class="px-6 py-4">Holiday</td>
                        <td class="px-6 py-4">ARG</td>
                        <td class="px-6 py-4">Usado</td>
                        <td class="px-6 py-4">dd/mm/aa</td>
                        <td class="px-6 py-4">1</td>
                        <td class="px-6 py-4">8 frascos</td>
                        <td class="px-6 py-4">Antinflamatorios</td>
                    </tr>
                </tbody>
            </table>
        </div>
        <nav class="flex-none flex items-center flex-column flex-wrap md:flex-row justify-between pt-4"
