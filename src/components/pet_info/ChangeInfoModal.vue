                ...
                <div class="relative bg-white rounded-lg shadow p-5">
                    <div class="p-5 text-center">
                            ...
                            <Field v-slot="{ field, errorMessage }" :validateOnInput="true" keep-value name="codigo">
                                ...
                                <div class="flex flex-col">
                                    <input id="codigo"
                                        ...
                                        type="text" v-bind="field" :value="pet?.codigo" />
                        ...
                        <div class="flex items-center mb-5">
                            <Field v-slot="{ field, errorMessage }" :validateOnInput="true" keep-value name="nombre">
                                ...
                                <div class="flex flex-col">
                                    <input id="nombre"
                                        class="border-primary text-gray-900 focus:border-primary-600 w-[10.7rem] lg:w-[12rem] sm:w-[10.7rem] md:w-[14rem] text-[0.8rem] sm:text-[0.8rem] md:text-[1rem] lg:text-[1.2rem]"
                                        type="text" v-bind="field" :value="pet?.nombre" />
                                    <span class="text-sm text-red-600 dark:text-red-500">
                                        {{ errorMessage }}
                                    </span>
                                </div>
                        ...
                        <div class="flex items-center mb-5">
                            <Field v-slot="{ field, errorMessage }" :validateOnInput="true" keep-value name="edad">
                                ...
                                <div class="flex flex-col">
                                    <input id="edad"
                                        class="border-primary text-gray-900 focus:border-primary-600 w-[10.7rem] lg:w-[12rem] sm:w-[10.7rem] md:w-[14rem] text-[0.8rem] sm:text-[0.8rem] md:text-[1rem] lg:text-[1.2rem]"
                                        type="number" step="1" v-bind="field"
                                        :value="pet?.edad?.toString() || 'Edad'" />
                                    <span class="text-sm text-red-600 dark:text-red-500">
                                        {{ errorMessage }}
                                    </span>
                                </div>
                        ...
                        <div class="flex items-center mb-5">
                            <Field v-slot="{ field, errorMessage }" :validateOnInput="true" keep-value name="ubicacion">
                                ...
                                <div class="flex flex-col">
                                    <input id="ubicacion"
                                        class="border-primary text-gray-900 focus:border-primary-600 w-[10.7rem] lg:w-[12rem] sm:w-[10.7rem] md:w-[14rem] text-[0.8rem] sm:text-[0.8rem] md:text-[1rem] lg:text-[1.2rem]"
                                        v-bind="field" :value="pet?.ubicacion" type="text" />
                                    <span class="text-sm text-red-600 dark:text-red-500">
                                        {{ errorMessage }}
                                    </span>
                                </div>
                        ...
                        <div class="flex items-center mb-5">
                            <Field v-slot="{ field, errorMessage }" :validateOnInput="true" keep-value name="peso">
                                ...
                                <div class="flex flex-col">
                                    <input id="peso"
                                        class="border-primary text-gray-900 focus:border-primary-600 w-[10.7rem] lg:w-[12rem] sm:w-[10.7rem] md:w-[14rem] text-[0.8rem] sm:text-[0.8rem] md:text-[1rem] lg:text-[1.2rem]"
                                        v-bind="field" :value="pet?.peso?.toString() || 'Peso'" type="number"
                                        step="1" />
                                    <span class="text-sm text-red-600 dark:text-red-500">
                                        {{ errorMessage }}
                                    </span>
                        ...
                        <div class="flex items-center mb-7">
                            ...
                            <input id="estado"
                                class="border-primary text-gray-900 focus:border-primary-600 w-[10.7rem] lg:w-[12rem] sm:w-[10.7rem] md:w-[14rem] text-[0.8rem] sm:text-[0.8rem] md:text-[1rem] lg:text-[1.2rem]"
                                name="pet?.estado" :value="pet?.adoptado ? 'Adoptado' : 'No adoptado'"
                                type="text" />
                        </div>
                        ...
                        <button
                            ...
                            data-modal-hide="info-modal" type="button">
                            Cancelar
                        </button>
                        <button
                            ...
                            data-modal-hide="info-modal" type="submit">
                            Guardar cambios
                        </button>
                    </div>
                </div>
