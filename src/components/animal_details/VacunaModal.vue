...
<template>
  ...
  <div
    ...
    tabindex="-1"
  >
    <div class="relative w-[23rem] sm:w-[26rem] md:w-[25rem] lg:w-[35rem]">
      <div class="relative bg-white rounded-lg shadow">
        <div class="px-10 py-9 text-center">
          ...
          <div class="flex items-center mb-4">
            <label
              class="mr-[4.3rem] md:mr-[4rem] sm:mr-[4.5rem] lg:mr-[4.6rem] font-normal text-gray-900 text-[0.8rem] sm:text-[1rem] md:text-[1rem] lg:text-[1.1rem]"
              for="name"
              >Nombre:
            </label>
            ...
            <input
              id="name"
              v-model="nombre"
              class="border-primary text-gray-900 w-[10.6rem] focus:border-primary-600 text-[0.8rem] sm:text-[1rem] md:text-[1rem] lg:text-[1.1rem] md:w-[12rem] sm:w-[12.6rem] lg:w-[22.1rem]"
              name="name"
          ...
          <div class="flex items-center">
            <label
              class="mr-[5.1rem] md:mr-[5rem] sm:mr-[5.5rem] lg:mr-[5.6rem] font-normal text-gray-900 text-[0.8rem] sm:text-[1rem] md:text-[1rem] lg:text-[1.1rem]"
              for="date"
              >Fecha:
            </label>
            ...
            <input
              id="date"
              v-model="fecha"
              class="border-primary text-gray-900 focus:border-primary-600 text-[0.8rem] sm:text-[1rem] md:text-[1rem] lg:text-[1.1rem] md:w-[12rem] sm:w-[13rem] w-[12rem] lg:w-[22.1rem]"
              name="date"
              type="date"
            />
          </div>
          ...
          <div class="mt-8">
            <button
              class="bg-surface drop-shadow font-normal border border-gray-200 hover:bg-gray-100 hover:text-primary hover:font-bold px-4 shadow-3xl rounded-full text-xs md:text-sm sm:text-sm sm:px-5 lg:text-md py-3 md:px-6 md:py-3 lg:px-8 lg:py-2.5 mr-4 sm:mr-10 md:mr-10 lg:mr-10"
            ...
            <button
              class="bg-primary drop-shadow text-white hover:bg-primary/75 hover:font-bold font-medium px-4 shadow-3xl rounded-full text-xs md:text-sm sm:text-sm sm:px-5 lg:text-md py-3 md:px-6 md:py-3 lg:px-8 lg:py-2.5"
              data-modal-hide="vacuna-modal"
              type="button"
              @click="addVacuna"
            >
